...
//
// RAS Core Library for South East Con 2026. I will refer to South East Con 2026
// as SECON2026 from here on out! This Library consist of common functions(etc.
// common robotics math func and utils func) and status codes.
//
...
static inline float ras_map(float x, float in_min, float in_max, float out_min,
                            float out_max);
...
static inline float ras_pid_compute(ras_pid_t *pid, float setpoint,
